...
export interface IGitHubServer {
	login(scopes: string, signInProvider?: GitHubSocialSignInProvider, extraParameter?: string, existingLogin?: string): Promise<string>;
...
export class GitHubServer implements IGitHubServer {
	...
	public async login(scopes: string, signInProvider?: GitHubSocialSignInProvider, extraParameter?: string, existingLogin?: string): Promise<string> {
